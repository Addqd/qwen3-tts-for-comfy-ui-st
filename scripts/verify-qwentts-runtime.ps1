...
foreach ($Property in $Manifest.models.files.PSObject.Properties) {
...
[PSCustomObject]@{
    ...
    files_checked = @($Manifest.files.PSObject.Properties).Count + @($Manifest.models.files.PSObject.Properties).Count
