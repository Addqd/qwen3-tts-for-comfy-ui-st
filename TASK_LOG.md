...
- Созданы коммиты: `fdf575d fix: harden ComfyUI node installation`, `c425df8 feat: expand ComfyUI API client diagnostics`, `9caaba7 feat: add ComfyUI service management and API tests`.
